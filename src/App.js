  ...
  return (
    <div className="full">
      ...
      <div className='modal' style={{ display: showModal ? 'flex' : 'none' }}>
        ...
        <a style={{ padding: '10px' }} className='repo' href='' target='_blank'>Github</a>
        <p>Designed and developed by</p>
        <a href='https://Jehan Mandal.netlify.app/' target='_blank' style={{ marginBlock: "5px" }}>Jehan Mandal</a>
